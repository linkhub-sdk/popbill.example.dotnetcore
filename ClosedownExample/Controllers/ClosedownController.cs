...
namespace ClosedownExample.Controllers
{
    public class ClosedownController : Controller
    {
         ...
         * - https://developers.popbill.com/reference/closedown/dotnetcore/api/point#GetBalance
         */
         ...
         * - https://developers.popbill.com/reference/closedown/dotnetcore/api/point#GetChargeURL
         */
         ...
         * - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
         * - https://developers.popbill.com/reference/closedown/dotnetcore/api/point#GetPaymentURL
         */
         ...
         * - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
         * - https://developers.popbill.com/reference/closedown/dotnetcore/api/point#GetUseHistoryURL
         */
         ...
         * - https://developers.popbill.com/reference/closedown/dotnetcore/api/point#GetPartnerBalance
         */
         ...
         * - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
         * - https://developers.popbill.com/reference/closedown/dotnetcore/api/point#GetPartnerURL
         */
         ...
         * - https://developers.popbill.com/reference/closedown/dotnetcore/api/member#CheckIsMember
         */
         ...
         * - https://developers.popbill.com/reference/closedown/dotnetcore/api/member#CheckID
         */
        ...
        /*
         * 사용자를 연동회원으로 가입처리합니다.
         * - https://developers.popbill.com/reference/closedown/dotnetcore/api/member#JoinMember
         */
        ...
        /*
         * 연동회원의 회사정보를 확인합니다.
         * - https://developers.popbill.com/reference/closedown/dotnetcore/api/member#GetCorpInfo
         */
        ...
        /*
         * 연동회원의 회사정보를 수정합니다.
         * - https://developers.popbill.com/reference/closedown/dotnetcore/api/member#UpdateCorpInfo
         */
         ...
         * - https://developers.popbill.com/reference/closedown/dotnetcore/api/member#RegistContact
         */
         ...
         * - https://developers.popbill.com/reference/closedown/dotnetcore/api/member#GetContactInfo
         */
         ...
         * - https://developers.popbill.com/reference/closedown/dotnetcore/api/member#ListContact
         */
        ...
        /*
         * 연동회원의 담당자 정보를 수정합니다.
         * - https://developers.popbill.com/reference/closedown/dotnetcore/api/member#UpdateContact
         */
         ...
         * - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
         * - https://developers.popbill.com/reference/closedown/dotnetcore/api/member#GetAccessURL
         */
