...
namespace TaxinvoiceExample.Controllers
{
    public class TaxinvoiceController : Controller
    {
        ...
        public IActionResult Register()
        {
            ...
            // [필수] 공급자 문서관리번호, 숫자, 영문, '-', '_' 조합으로 
            //  1~24자리까지 사업자번호별 중복없는 고유번호 할당
            taxinvoice.invoicerMgtKey = "20181030-002";
        ...
        public IActionResult Update()
        {
            ...
            detail.serialNum = 1; // 일련번호, 1부터 순차기재 
            detail.purchaseDT = "20181030"; // 거래일자
            detail.itemName = "품목명"; // 품목명 
            detail.spec = "규격"; // 규격
            detail.qty = "1"; // 수량
            detail.unitCost = "50000"; // 단가
        ...
        */
        public IActionResult RegistContact()
        {
            ...
            // 담당자 메일주소
            contactInfo.email = "aspnetcore@linkhub.co.kr";
        ...
        */
        public IActionResult UpdateContact()
        {
            ...
            // 담당자명 
            contactInfo.personName = "담당자명 수정";
