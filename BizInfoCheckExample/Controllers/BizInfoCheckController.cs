...
namespace BizInfoCheckExample.Controllers
{
    public class BizInfoCheckController : Controller
    {
        ...
        /*
         * 연동회원 포인트를 환불 신청합니다.
         * - https://developers.popbill.com/reference/bizinfocheck/dotnetcore/api/point#PaymentRequest
         */
         ...
         *  - https://developers.popbill.com/reference/bizinfocheck/dotnetcore/api/point#GetSettleResult
         */
         ...
         * - https://developers.popbill.com/reference/bizinfocheck/dotnetcore/api/point#GetUseHistory
         */
         ...
         * - https://developers.popbill.com/reference/bizinfocheck/dotnetcore/api/point#GetPaymentHistory
         */
         ...
         * - https://developers.popbill.com/reference/bizinfocheck/dotnetcore/api/point#GetRefundHistory
         */
         ...
         * - https://developers.popbill.com/reference/bizinfocheck/dotnetcore/api/point#GetRefundInfo
         */
         ...
         * - https://developers.popbill.com/reference/bizinfocheck/dotnetcore/api/point#GetRefundableBalance
         */
         ...
         *  - 관리자 계정만 사용 가능합니다.
         *  - https://developers.popbill.com/reference/bizinfocheck/dotnetcore/api/member#QuitMember
         */
