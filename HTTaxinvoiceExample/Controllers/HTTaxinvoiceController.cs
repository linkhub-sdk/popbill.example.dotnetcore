...
namespace HTTaxinvoiceExample.Controllers
{
    public class HTTaxinvoiceController : Controller
    {
         ...
         * - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/point#GetFlatRatePopUpURL
         */
         ...
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/point#GetFlatRateState
         */
         ...
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/point#GetBalance
         */
         ...
         * - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/point#GetChargeURL
         */
         ...
         * - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/point#GetPaymentURL
         */
         ...
         * - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/point#GetUseHistoryURL
         */
         ...
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/point#GetPartnerBalance
         */
         ...
         * - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/point#GetPartnerURL
         */
         ...
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/point#GetChargeInfo
         */
        public IActionResult GetChargeInfo()
        {
            ...
            catch (PopbillException pe)
            {
                ...
                /*
         * 연동회원 포인트를 환불 신청합니다.
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/point#Refund
         */
        ...
        /*
         * 연동회원 포인트를 환불 신청합니다.
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/point#PaymentRequest
         */
         ...
         *  - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/point#GetSettleResult
         */
         ...
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/point#GetUseHistory
         */
         ...
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/point#GetPaymentHistory
         */
         ...
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/point#GetRefundHistory
         */
         ...
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/point#GetRefundInfo
         */
         ...
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/point#GetRefundableBalance
         */
         ...
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/member#CheckIsMember
         */
         ...
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/member#CheckID
         */
        ...
        /*
         * 사용자를 연동회원으로 가입처리합니다.
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/member#JoinMember
         */
         ...
         * - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/member#GetAccessURL
         */
        ...
        /*
         * 연동회원의 회사정보를 확인합니다.
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/member#GetCorpInfo
         */
        ...
        /*
         * 연동회원의 회사정보를 수정합니다.
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/member#UpdateCorpInfo
         */
         ...
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/member#RegistContact
         */
         ...
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/member#GetContactInfo
         */
         ...
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/member#ListContact
         */
         ...
         * - https://developers.popbill.com/reference/httaxinvoice/dotnetcore/api/member#UpdateContact
         */
         ...
         *  - 관리자 계정만 사용 가능합니다.
         *  - https://developers.popbill.com/reference/hthttaxinvoice/dotnetcore/api/member#QuitMember
         */
